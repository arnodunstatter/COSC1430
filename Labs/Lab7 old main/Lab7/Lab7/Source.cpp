...
/*
1. There is an issue with the + operator,
something to do with access (look into the 
return types)
--Removing the custom destructor allows the
+ operator to work, but then we leave the matrices 
with memory leaks

2. There's also somethign wrong with 
the destructor
*/